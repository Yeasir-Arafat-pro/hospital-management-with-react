...
import { useDeleteBillingMutation, useGetBillingQuery } from "../billingApi";
...
const BillingList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      accessorFn: (row) =>
        format(new Date(row.appointment.datetime), "dd MMM yyyy"),
    },
    {
      header: "Sub Total",
